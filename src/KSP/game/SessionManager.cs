...
namespace KSP.Game
{
  ...
  public class SessionManager
  {
    ...
    private CampaignMode _activeCampaignMode;
    private DifficultyLevel _activeCampaignDifficultyLevel;
    ...
    private TravelLogManager _travelLogManager;
    ...
    public CampaignMode ActiveCampaignMode
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetActiveCampaignMode(CampaignMode activeCampaignMode) => throw null;

    public DifficultyLevel ActiveCampaignDifficultyLevel
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetActiveCampaignDifficultyLevel(DifficultyLevel activeCampaignDifficultyLevel) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetActiveCampaignDefaultDifficultyOptions(
    ...
    public TravelLogManager TravelLogManager
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }
    ...
    public void InitializeSessionData(
      ...
      SerializedSaveGameMetadata sessionData)
    {
      throw null;
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool ImportSerializedSessionManager(SerializedSessionManager serializedSessionManager) => throw null;
