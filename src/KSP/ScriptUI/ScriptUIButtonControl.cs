...
// Type: KSP.ScriptUI.ScriptUIButtonControl
...
{
  public class ScriptUIButtonControl : ScriptUIControl, ICreateControl
  {
    private string script;
    private string label;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static int Create(ScriptUIWindow wnd, string script, string label) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public ScriptUIButtonControl() => throw null;
  }
}
