...
namespace KSP.Input
{
    ...
    IDisposable
  {
    ...
    private GameInput.IFlightActions m_FlightActionsCallbackInterface;
    ...
    private readonly InputAction m_Flight_ToggleFlightHUD;
    ...
    private GameInput.IGlobalActions m_GlobalActionsCallbackInterface;
    ...
    private GameInput.IEVAActions m_EVAActionsCallbackInterface;
    ...
    private readonly InputActionMap m_OAB;
    private GameInput.IOABActions m_OABActionsCallbackInterface;
    private readonly InputAction m_OAB_delete;
    private readonly InputAction m_OAB_nextSymmetryMode;
    private readonly InputAction m_OAB_previousSymmetryMode;
    private readonly InputAction m_OAB_toggleAngleSnap;
    private readonly InputAction m_OAB_disableStackAttachment;
    private readonly InputAction m_OAB_resetPartRotation;
    private readonly InputAction m_OAB_resetCamera;
    private readonly InputAction m_OAB_hotKeyModifier;
    private readonly InputAction m_OAB_modifier;
    private readonly InputAction m_OAB_fastScrollModifier;
    private readonly InputAction m_OAB_copy;
    private readonly InputAction m_OAB_search;
    private readonly InputAction m_OAB_paste;
    private readonly InputAction m_OAB_undo;
    private readonly InputAction m_OAB_redo;
    private readonly InputAction m_OAB_toolMove;
    private readonly InputAction m_OAB_cameraPan;
    private readonly InputAction m_OAB_cameraFastModifier;
    private readonly InputAction m_OAB_cameraLook;
    private readonly InputAction m_OAB_cameraRotate;
    private readonly InputAction m_OAB_cameraZoom;
    private readonly InputAction m_OAB_toolMoveUpDown;
    private readonly InputAction m_OAB_toolNumbers;
    private readonly InputAction m_OAB_mousePrimary;
    private readonly InputAction m_OAB_mouseSecondary;
    private readonly InputAction m_OAB_mouseTertiary;
    private readonly InputAction m_OAB_testSave;
    private readonly InputAction m_OAB_testLoad;
    private readonly InputAction m_OAB_rotatePitch;
    private readonly InputAction m_OAB_rotateYaw;
    private readonly InputAction m_OAB_rotateRoll;
    private readonly InputAction m_OAB_setSymmetryMirrorMode;
    private readonly InputAction m_OAB_addFavorite;
    private readonly InputAction m_OAB_lockTarget;
    private readonly InputAction m_OAB_quitOrthoView;
    private readonly InputAction m_OAB_toggleConsoleToolbox;
    private readonly InputAction m_OAB_blueprintModeGamepad;
    private readonly InputAction m_OAB_launch;
    private readonly InputAction m_OAB_modifierGamepad;
    private readonly InputAction m_OAB_cameraZoomGamepad;
    private readonly InputAction m_OAB_cameraPanGamepad;
    private readonly InputAction m_OAB_rotatePartGamepad;
    private readonly InputAction m_OAB_toggleFilterGamepad;
    private readonly InputAction m_OAB_toggleCategoriesGamepad;
    private readonly InputAction m_OAB_toggleFrameOfReference;
    private readonly InputAction m_OAB_selectAllPrimaryAssembly;
    private readonly InputAction m_OAB_tooltipPageDown;
    private readonly InputAction m_OAB_tooltipPageUp;
    private readonly InputActionMap m_MapView;
    private GameInput.IMapViewActions m_MapViewActionsCallbackInterface;
    ...
    private GameInput.IRDActions m_RDActionsCallbackInterface;
    ...
    private GameInput.ICursorActions m_CursorActionsCallbackInterface;
    ...
    private GameInput.INavigation_Move_DPadActions m_Navigation_Move_DPadActionsCallbackInterface;
    ...
    private GameInput.INavigation_Move_LeftStickActions m_Navigation_Move_LeftStickActionsCallbackInterface;
    ...
    private GameInput.INavigation_SubmitActions m_Navigation_SubmitActionsCallbackInterface;
    ...
    private GameInput.INavigation_QuitActions m_Navigation_QuitActionsCallbackInterface;
    private readonly InputAction m_Navigation_Quit_Quit;
    private readonly InputActionMap m_Navigation_Scroll;
    private GameInput.INavigation_ScrollActions m_Navigation_ScrollActionsCallbackInterface;
    private readonly InputAction m_Navigation_Scroll_Scroll;
    private readonly InputActionMap m_ConsoleToolbox;
    private GameInput.IConsoleToolboxActions m_ConsoleToolboxActionsCallbackInterface;
    private readonly InputAction m_ConsoleToolbox_Hide;
    private readonly InputActionMap m_Navigation_Slider;
    private GameInput.INavigation_SliderActions m_Navigation_SliderActionsCallbackInterface;
    ...
    private GameInput.IKSCActions m_KSCActionsCallbackInterface;
    private readonly InputAction m_KSC_ShowMap;
    private readonly InputActionMap m_Audio;
    private GameInput.IAudioActions m_AudioActionsCallbackInterface;
    ...
    public GameInput.OABActions OAB
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }
    ...
    public struct FlightActions
    {
      ...
      public InputAction ToggleFlightHUD
      {
        [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
      }
    ...
    public struct OABActions
    {
      private GameInput m_Wrapper;

      [MethodImpl(MethodImplOptions.NoInlining)]
      public OABActions(GameInput wrapper) => throw null;
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      public static implicit operator InputActionMap(GameInput.OABActions set) => throw null;

      [MethodImpl(MethodImplOptions.NoInlining)]
      public void SetCallbacks(GameInput.IOABActions instance) => throw null;
    }
    ...
    public interface IFlightActions
    {
      ...
      void OnToggleFlightHUD(InputAction.CallbackContext context);
