...
namespace I2.Loc
{
  public static class LocalizationManager
  {
    ...
    private const string FILE_NAME_LOCKEY = "_FileName";
    private const string VEHICLE_NAME_LOCKEY = "_VehicleName";
    private const string WORSKPACE_ENTRY_NAME_DIVIDER = " - ";
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static bool TryGetWorkspaceName(
      string workspaceName,
      OABVariant oABVariant,
      out string Translation)
    {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static bool TryGetWorkspaceVehicleName(
      string workspaceName,
      string vehicleName,
      OABVariant oABVariant,
      out string Translation)
