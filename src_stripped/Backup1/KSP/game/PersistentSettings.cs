...
namespace KSP.Game
{
  ...
  public class PersistentSettings : VersionedBase
  {
    ...
    [JsonProperty("ShowNavballInMapView")]
    ...
    public const float DEFAULT_GLOBAL_UI_SCALE_PERCENT = 100f;
    [JsonProperty("GlobalUIScale")]
    public float GlobalUIScale;
    [JsonProperty("AutoSaveCooldownTimes")]
