...
// Type: KSP.Game.Missions.MissionReloadSnapshotAction
...
{
  [Serializable]
  public class MissionReloadSnapshotAction : MissionActionBase, IMissionAction
  {
    [JsonIgnore]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public MissionReloadSnapshotAction() => throw null;
  }
}
