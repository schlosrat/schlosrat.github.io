...
// Type: KSP.OAB.ObjectAssemblySelectLaunchTool
...
namespace KSP.OAB
{
  public class ObjectAssemblySelectLaunchTool : ObjectAssemblyPlacementTool
  {
    [MethodImpl(MethodImplOptions.NoInlining)]
    public ObjectAssemblySelectLaunchTool(
