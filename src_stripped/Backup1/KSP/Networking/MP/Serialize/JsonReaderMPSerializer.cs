...
// Type: KSP.Networking.MP.Serialize.JsonReaderMPSerializer
...
{
  public class JsonReaderMPSerializer : IMPSerializer
  {
    ...
    public static T EnumStringParser<T>(string str) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public JsonReaderMPSerializer(bool errorAsWarning = false) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetParams(string jsonString) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void ReadInData<T>(
      string varName,
      ref T valueRef,
      DefaultValueFactory<T> defaultValueFactory,
      T defaultValueIfNull,
      JsonReaderMPSerializer.ParserFunc<T> parserFunc)
    {
      throw null;
    }
    ...
    public delegate T ParserFunc<T>(string str);
  }
}
