...
// Type: KSP.Networking.MP.Serialize.ResetValuesMPSerializer
...
{
  public class ResetValuesMPSerializer : IMPSerializer
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public ResetValuesMPSerializer(bool errorAsWarning = false) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    ~ResetValuesMPSerializer() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetParams(string filterString = null) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public bool PassFilter(string varName) => throw null;
