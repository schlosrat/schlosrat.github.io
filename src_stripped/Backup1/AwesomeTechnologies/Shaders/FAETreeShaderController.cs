...
// Type: AwesomeTechnologies.Shaders.FAETreeShaderController
...
namespace AwesomeTechnologies.Shaders
{
  public class FAETreeShaderController : IShaderController
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private bool IsTrunkShader(string shaderName) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public FAETreeShaderController() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    static FAETreeShaderController() => throw null;
  }
}
