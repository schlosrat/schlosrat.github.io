...
// Type: MoonSharp.Interpreter.Platforms.StandardPlatformAccessor
...
namespace MoonSharp.Interpreter.Platforms
{
  public class StandardPlatformAccessor : PlatformAccessorBase
  {
    ...
    public static FileAccess ParseFileAccess(string mode) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static FileMode ParseFileMode(string mode) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public StandardPlatformAccessor() => throw null;
  }
}
