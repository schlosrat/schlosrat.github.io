...
// Type: LibNoise.Modifiers.Select
...
namespace LibNoise.Modifiers
{
  public class Select : Math, IModule
  {
    ...
    public Select(IModule control, IModule source1, IModule source2) => throw null;
    ...
    public Select(
      ...
      double upperbound,
      double edgefalloff,
      IModule inputmodule1,
      IModule inputmodule2)
    {
      throw null;
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetBounds(double lower, double upper) => throw null;
