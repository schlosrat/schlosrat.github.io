...
// Type: LibNoise.Modifiers.ScaleBiasOutput
...
namespace LibNoise.Modifiers
{
  public class ScaleBiasOutput : IModule
  {
    ...
    public ScaleBiasOutput(IModule sourceModule) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public ScaleBiasOutput(double scale, double bias, IModule sourcemodule) => throw null;
