...
public static class XKCDColors
{
  ...
  public static float NextColorAlpha;

  [MethodImpl(MethodImplOptions.NoInlining)]
  public static Color A(this Color c, float a) => throw null;

  [MethodImpl(MethodImplOptions.NoInlining)]
  public static Color32 A(this Color32 c, byte a) => throw null;
  ...
  [MethodImpl(MethodImplOptions.NoInlining)]
  static XKCDColors() => throw null;

  public class ColorTranslator
  {
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static Color FromHtml(string hexString) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static string ToHex(Color c) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static string ToHexA(Color c) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public ColorTranslator() => throw null;
  }
