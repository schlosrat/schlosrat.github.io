...
namespace KSP.TriggersTools
{
  public class TriggersTools : KerbalMonoBehaviour
  {
    ...
    [SerializeField]
    private Transform tempStatsParent;
    [SerializeField]
    private TriggersToolsPartThermalsRow _thermalRowPrefab;
    [SerializeField]
    ...
    private bool _isTempsShowing;
    private List<TriggersToolsPartThermalsRow> _thermalRows;
    [SerializeField]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void GetPartTemps(bool show) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void UpdateTempValues() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void UpdateViewTempValues() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void ClearPartThermalStats() => throw null;
