...
namespace KSP.Modules
{
  ...
  public class Module_Engine : PartBehaviourModule, IEngineStatus
  {
    ...
    [SerializeField]
    private string _engineModeChangeAnimationTriggerParamName;
    [SerializeField]
    private string _engineModeIndexAnimationParamName;
    public FlameoutVFXData FlameoutVFX;
    public List<Transform> ThrustTransforms;
    [Tooltip("Proportional contribution of every Thrust Transform. The sum of all values must be equal to 1 (100%)")]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private IEnumerator SwitchingEngineMode(EngineState currentState, int newEngineModeIndex) => throw null;
