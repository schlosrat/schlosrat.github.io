...
// Type: KSP.VFX.FXKSCLaunchFireContextualEvent
...
namespace KSP.VFX
{
  public class FXKSCLaunchFireContextualEvent : FXKSCLaunchContextualEvent
  {
    ...
    public FXKSCLaunchFireContextualEvent(
