...
// Type: KSP.VFX.FXPersistantSurfaceContactContextualEvent
...
namespace KSP.VFX
{
  public class FXPersistantSurfaceContactContextualEvent : FXCollisionContextualEvent
  {
    ...
    public FXPersistantSurfaceContactContextualEvent(
