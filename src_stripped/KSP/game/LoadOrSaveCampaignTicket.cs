...
namespace KSP.Game
{
  public class LoadOrSaveCampaignTicket
  {
    ...
    public const CampaignMode DEFAULT_CAMPAIGN_MODE = CampaignMode.Invalid;
    ...
    private CampaignMode _campaignMode;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetCampaignMode(CampaignMode campaignMode) => throw null;
