...
namespace KSP.Game
{
  public class NewGameSetupInfo
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public NewGameSetupInfo(DifficultyOptionsData initialDifficultyOptionsData) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void Init(DifficultyOptionsData initialDifficultyOptionsData) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void Set(DifficultyOptionsData initialDifficultyOptionsData) => throw null;
