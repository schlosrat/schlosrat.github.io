...
namespace KSP.Game
{
  ...
  {
    private const uint SPECIAL_KERBALS_REFRESH_RATE = 3;
    ...
    private Dictionary<string, uint> _customKerbalRefresh;
    ...
    private List<string> _neverUsedCustomKerbals;
    private List<string> _neverUsedVeteranKerbals;
    private bool _isKerbalAssemblyTemplateInitialized;
    private double _kerbalIVAMass;
    private SimulationObjectModel _ksc;
    private KerbalRosterManager.CustomKerbalHandlingOptions _defaultCustomeKerbalOptions;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void RemoveNeverUsedCustomNameKey(string customKerbalKey) => throw null;
    ...
    public class CustomKerbalHandlingOptions
    {
      ...
      public bool PrioritizeVeteranKerbals;
