...
// Type: KSP.Game.Missions.MissionPauseAction
...
{
  [Serializable]
  public class MissionPauseAction : MissionActionBase, IMissionAction
  {
    [JsonIgnore]
    public string ParentMissionID;
    [JsonIgnore]
    private bool _pauseCalled;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public MissionPauseAction() => throw null;
  }
}
