...
// Type: KSP.UI.Binding.UIValue_ReadBool_SetEnabled
...
{
  public class UIValue_ReadBool_SetEnabled : UIValueBinder<bool>
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public UIValue_ReadBool_SetEnabled() => throw null;
  }
}
