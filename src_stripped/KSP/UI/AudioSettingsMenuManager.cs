...
namespace KSP.UI
{
  public class AudioSettingsMenuManager : SettingsSubMenu
  {
    ...
    private const string KERBAL_IVA_PROPERTY_KEY = "KerbalIVA";
    ...
    private Property<float> _kerbalIVA;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void ApplyKerbalIVAVolume(float selectionValue) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void OnKerbalIVALevelChanged(float value) => throw null;
