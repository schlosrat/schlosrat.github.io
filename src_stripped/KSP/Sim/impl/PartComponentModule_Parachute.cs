...
// Type: KSP.Sim.impl.PartComponentModule_Parachute
...
{
  public class PartComponentModule_Parachute : PartComponentModule
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public PartComponentModule_Parachute() => throw null;
  }
}
