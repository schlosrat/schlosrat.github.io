...
namespace KSP.Sim.impl
{
  public class UniverseCameraManager : KerbalCameraBehaviour, ILateUpdate, ICameraGimbalStateProvider
  {
    ...
    private const string GROUND_TWEAKABLES_KEY = "GroundCameraTweakables";
    private const string ORBITAL_TWEAKABLES_KEY = "OrbitalCameraTweakables";
    private const string EVA_GROUND_TWEAKABLES_KEY = "EVAGroundCameraTweakables";
    private const string EVA_ORBITAL_TWEAKABLES_KEY = "EVAOrbitalCameraTweakables";
    private const string KSC_TWEAKABLES_KEY = "KSCCameraTweakables";
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private CameraTweakables GetCameraTweakables(string key) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void AssignCameraTweakablesContext(string key) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void LoadCameraTweakablesFromFile(string key, Action<CameraTweakables> onLoadedCallback) => throw null;
