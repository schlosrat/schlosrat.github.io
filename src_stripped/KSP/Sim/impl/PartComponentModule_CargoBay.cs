...
// Type: KSP.Sim.impl.PartComponentModule_CargoBay
...
{
  public class PartComponentModule_CargoBay : PartComponentModule
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public PartComponentModule_CargoBay() => throw null;
  }
}
