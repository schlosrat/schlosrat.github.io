...
// Type: KSP.Sim.impl.PartComponentModule_Decouple
...
{
  public class PartComponentModule_Decouple : PartComponentModule
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public PartComponentModule_Decouple() => throw null;
  }
}
