...
// Type: KSP.Messages.MapCelestialBodyAddedMessage
...
{
  public class MapCelestialBodyAddedMessage : MessageCenterMessage
  {
    ...
    public CoreCelestialBodyData bodyData
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
      [MethodImpl(MethodImplOptions.NoInlining)] set => throw null;
    }
    ...
    public MapCelestialBodyAddedMessage() => throw null;
  }
}
