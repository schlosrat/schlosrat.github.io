...
// Type: AwesomeTechnologies.Shaders.NMAdvancedGrassSnowController
...
namespace AwesomeTechnologies.Shaders
{
  public class NMAdvancedGrassSnowController : IShaderController
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public NMAdvancedGrassSnowController() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    static NMAdvancedGrassSnowController() => throw null;
  }
}
