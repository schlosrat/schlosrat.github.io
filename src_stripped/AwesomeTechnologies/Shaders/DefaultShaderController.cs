...
// Type: AwesomeTechnologies.Shaders.DefaultShaderController
...
namespace AwesomeTechnologies.Shaders
{
  ...
  {
    private const string SCATTER_ALPHA_TEST_SHADER = "KSP2/Environment/Scatter/Scatter_Instanced_Indirect_AlphaTest";
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public DefaultShaderController() => throw null;
  }
}
