...
namespace AwesomeTechnologies.VegetationSystem
{
  public class VegetationItemModelInfo
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static Mesh GetVegetationMesh(GameObject rootVegetationModel, LODLevel lodLevel) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public ComputeBuffer GetLODVisibleBuffer(int lodIndex, int cameraIndex, bool shadows) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public List<ComputeBuffer> GetLODArgsBufferList(int lodIndex, int cameraIndex, bool shadows) => throw null;
