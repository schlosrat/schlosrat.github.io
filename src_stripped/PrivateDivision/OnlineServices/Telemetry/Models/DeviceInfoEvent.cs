...
// Type: PrivateDivision.OnlineServices.Telemetry.Models.DeviceInfoEvent
...
namespace PrivateDivision.OnlineServices.Telemetry.Models
{
  public class DeviceInfoEvent
  {
    ...
    [JsonProperty("graphicsMultiThreaded")]
    ...
    public long ProcessorFrequency
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
      [MethodImpl(MethodImplOptions.NoInlining)] set => throw null;
    }
    ...
    public DeviceInfoEvent() => throw null;
  }
}
