...
namespace I2.Loc
{
  public class LocalizeTarget_UnityStandard_Prefab : LocalizeTarget<GameObject>
  {
    ...
    static LocalizeTarget_UnityStandard_Prefab() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private Transform InstantiateNewPrefab(Localize cmp, string mainTranslation) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public LocalizeTarget_UnityStandard_Prefab() => throw null;
  }
}
