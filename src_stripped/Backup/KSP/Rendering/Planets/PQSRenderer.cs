...
namespace KSP.Rendering.Planets
{
  ...
  public class PQSRenderer : KerbalMonoBehaviour, IPQSRenderer
  {
    ...
    private static readonly int sp_TerrainHeightTexture;
    ...
    [Tooltip("Which quality is used for display in Unity Editor.\nAbout the build version, at present the quality of XBoxOne and PS4 are Good, other platforms are Best.")]
    ...
    [HideInInspector]
    public OceanFeature GoodOceanFeaure;
    [HideInInspector]
    public OceanFeature BetterOceanFeaure;
    [HideInInspector]
    public OceanFeature BestOceanFeaure;
    [HideInInspector]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void GenerateTerrainHeightTexture() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void GenerateOceanMaskTexture() => throw null;
