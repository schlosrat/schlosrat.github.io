...
// Type: KSP.VFX.FXKSCLaunchSmokeContextualEvent
...
namespace KSP.VFX
{
  public class FXKSCLaunchSmokeContextualEvent : FXKSCLaunchContextualEvent
  {
    ...
    public FXKSCLaunchSmokeContextualEvent(
