...
namespace KSP.Game
{
  ...
  {
    [JsonIgnore]
    public const DifficultyModeAndLevel DEFAULT_NAME = DifficultyModeAndLevel.Invalid;
    [JsonIgnore]
    public const DifficultyLevel DEFAULT_DIFFICULTY = DifficultyLevel.Normal;
    [JsonIgnore]
    public const CampaignMode DEFAULT_MODE = CampaignMode.Exploration;
    [JsonIgnore]
    ...
    [JsonProperty]
    public DifficultyModeAndLevel name;
    [JsonProperty]
    ...
    public static DifficultyModeAndLevel GetDifficultyModeAndLevel(
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void UpdateName() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetHeader(CampaignMode campaignMode, DifficultyLevel difficultyLevel) => throw null;
