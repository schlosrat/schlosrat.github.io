...
// Type: KSP.Game.CampaignPlayerEntryEventData
...
namespace KSP.Game
{
  public class CampaignPlayerEntryEventData
  {
    public const string DEFAULT_PLAYER_GUID_STRING = "";
    public const CampaignPlayerEntryEvent DEFAULT_CAMPAIGN_PLAYER_ENTRY_EVENT = CampaignPlayerEntryEvent.None;
    public const CampaignPlayerEntryField DEFAULT_CAMPAIGN_PLAYER_ENTRY_FIELD = CampaignPlayerEntryField.None;
    ...
    private CampaignPlayerEntryEvent _campaignPlayerEntryEvent;
    private CampaignPlayerEntryField _campaignPlayerEntryField;
    ...
    public CampaignPlayerEntryEvent CampaignPlayerEntryEvent
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetCampaignPlayerEntryEvent(CampaignPlayerEntryEvent campaignPlayerEntryEvent) => throw null;

    public CampaignPlayerEntryField CampaignPlayerEntryField
    {
      [MethodImpl(MethodImplOptions.NoInlining)] get => throw null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetCampaignPlayerEntryField(CampaignPlayerEntryField campaignPlayerEntryField) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void SetCompletedTutorialsStringOrNull(string completedTutorialStringOrNull) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public CampaignPlayerEntryEventData() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public CampaignPlayerEntryEventData(
      string playerGuidString,
      CampaignPlayerEntryEvent campaignPlayerEntryEvent,
      CampaignPlayerEntryField campaignPlayerEntryField,
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public CampaignPlayerEntryEventData(CampaignPlayerEntryEventData src) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void Init(CampaignPlayerEntryEventData src) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void Set(CampaignPlayerEntryEventData src) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static CampaignPlayerEntryEventData() => throw null;
  }
}
