...
// Type: KSP.Game.Missions.MissionCreateSnapshotAction
...
{
  [Serializable]
  public class MissionCreateSnapshotAction : MissionActionBase, IMissionAction
  {
    [JsonIgnore]
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public MissionCreateSnapshotAction() => throw null;
  }
}
