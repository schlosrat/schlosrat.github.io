...
// Type: KSP.Sim.impl.PartComponentModule_WheelBase
...
{
  public class PartComponentModule_WheelBase : PartComponentModule
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public PartComponentModule_WheelBase() => throw null;
  }
}
