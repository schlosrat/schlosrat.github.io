...
namespace KSP.Sim.impl
{
    ...
    IAngularMotionDriver
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void GetAltitudeFromSeaLevel(Position pos, out double altFromSeaLevel) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public double GetAltitudeFromRadius(Vector3d position, ICoordinateSystem coordinateSystem) => throw null;
