...
// Type: AwesomeTechnologies.Shaders.Speedtree8ShaderController
...
namespace AwesomeTechnologies.Shaders
{
  public class Speedtree8ShaderController : IShaderController
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private bool HasKeyword(Material material, string keyword) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void UpdateWind(Material material, WindSettings windSettings) => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    public Speedtree8ShaderController() => throw null;
  }
}
