...
namespace AwesomeTechnologies.VegetationSystem
{
  ...
  public class VegetationSystemPro : MonoBehaviour
  {
    ...
    public ComputeBuffer _cellArgsBuffer;
    private readonly uint[] _cellArgs;
    ...
    private int _cellArgsID;
    private int _spawningArgsID;
    private int _mergeBufferID;
    private int _mergeSourceBuffer0ID;
    private int _mergeSourceBuffer1ID;
    private int _mergeSourceBuffer2ID;
    private int _mergeSourceBuffer3ID;
    private int _mergeSourceBuffer4ID;
    private int _mergeSourceBuffer5ID;
    private int _mergeSourceBuffer6ID;
    private int _mergeSourceBuffer7ID;
    private int _mergeSourceBuffer8ID;
    private int _mergeSourceBuffer9ID;
    private int _mergeSourceBuffer10ID;
    private int _mergeSourceBuffer11ID;
    private int _mergeSourceBuffer12ID;
    private int _mergeSourceBuffer13ID;
    private int _mergeSourceBuffer14ID;
    private int _mergeInstanceCount0ID;
    private int _mergeInstanceCount1ID;
    private int _mergeInstanceCount2ID;
    private int _mergeInstanceCount3ID;
    private int _mergeInstanceCount4ID;
    private int _mergeInstanceCount5ID;
    private int _mergeInstanceCount6ID;
    private int _mergeInstanceCount7ID;
    private int _mergeInstanceCount8ID;
    private int _mergeInstanceCount9ID;
    private int _mergeInstanceCount10ID;
    private int _mergeInstanceCount11ID;
    private int _mergeInstanceCount12ID;
    private int _mergeInstanceCount13ID;
    private int _mergeInstanceCount14ID;
    ...
    private HashSet<VegetationCell> incompletelySpawnedCells;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void CleanUpComponents() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void RenderInstancedVegetation() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void SetupInstancedRenderMaterialPropertiesIDs() => throw null;

    [MethodImpl(MethodImplOptions.NoInlining)]
    private void RenderVegetationItemLODDrawMesh(
      NativeList<Matrix4x4> matrixList,
      NativeList<Vector4> lodFadeList,
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void RenderVegetationItemLOD(
      NativeList<Matrix4x4> matrixList,
      NativeList<Vector4> lodFadeList,
      VegetationItemModelInfo vegetationItemModelInfo,
      int lodIndex,
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void RefreshBillboards() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void ClearBillboardCellsCache(int vegetationPackageIndex, int vegetationItemIndex) => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void SetupBillboardShaderIDs() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private void DisposeComputeShaders() => throw null;
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public NativeList<MatrixInstance> GetVegetationItemInstances(
      VegetationCell vegetationCell,
