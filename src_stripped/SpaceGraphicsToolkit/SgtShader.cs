...
// Type: SpaceGraphicsToolkit.SgtShader
...
namespace SpaceGraphicsToolkit
{
  public static class SgtShader
  {
    ...
    public static int _ShadowScale;
    public static int _Body01_Color;
    public static int _Body01_Intensity;
    public static int _Body01_Pos;
    public static int _RingEdgeFade;
    public static int _NormalTex;

    [MethodImpl(MethodImplOptions.NoInlining)]
    static SgtShader() => throw null;
  }
}
